                ...
                <div class="row">
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="header_logo"><a href="index.php?page=home">

                                    <img src="assets/images/logo.png" alt="SmartOSC" class="logo"></a></div>
                            <nav class="main_nav">
                                <ul>
                                    <li>
                                    ...
                                    <li>
                                        <a href="index.php?page=list">Manage</a>
                                    </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        <?php foreach ($colors as $key => $color): ?>
                            <div class="list-group-item">
                                <input type="checkbox" value="<?php echo $color['id']; ?>"
                                       name="color_id"> <?php echo $color['color']; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="list-group">
                        <div class="list-group-item" style="display: grid" >
                            <select name="category" id="" size="9" multiple>
                ...
                <div class="col-md-9">
                    ...
                    <div class="product_grid">
                        ...
                        <?php foreach ($Carts as $key => $cart):?>
                            <div class="product">
                                <div class="product_image"><img src="img/<?php echo $cart['image'] ?>" alt=""
                                                                style="width: 210px;height: 210px"></div>
                                <div class="product_extra product_new"><a href="#">New</a></div>
                                <div class="product_content">
                                    <div class="product_title"><a href="index.php?page=detail&id=<?php echo $cart['id'] ?>"><?php echo $cart['name'] ?></a></div>
                                    <div class="product_price"><?php echo $cart['price'] ?> đ</div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <div align="center">
                        ...
                        for ($i = 1; $i <= $numberPages; $i++) {
                            echo "<a href='index.php?page=home&pages=$i'>Trang $i - </a>";
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="avds_xl_container clearfix">
                        <div class="avds_xl_background"
                             style="background-image:url(./assets/images/avds_xl.jpg)"></div>
            ...
            <div class="row">
                <div class="col">
                    <div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                        <div class="footer_logo"><a href="index.php?page=home">
                                <img src="./assets/images/logo.png" alt="SmartOSC" class="logo"></a>
                        </div>
